...
> **Version / 版本：** 2.1
> **Adopted by / 采纳方：** ZWISERFIT AI Store Manager
...
我们作为社区成员、贡献者和领导者，承诺使社区中的参与成为一种不受骚扰的体验，无论年龄、体型、可见或不可见的残疾、民族、性别特征、性别认同与表达、经验水平、教育程度、社会经济地位、国籍、个人外表、种族、种姓、肤色、宗教或性取向如何。

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community.

我们承诺以促成开放、欢迎、多元、包容和健康社区的方式行动和互动。

---

## Our Standards / 我们的标准

### Positive Behaviors / 积极行为

Examples of behavior that contributes to a positive environment for our community include:

为社区营造积极环境的示例行为包括：

- Demonstrating empathy and kindness toward other people / 对他人表现出同理心与善意
- Being respectful of differing opinions, viewpoints, and experiences / 尊重不同的意见、观点和经历
- Giving and gracefully accepting constructive feedback / 给予并优雅地接受建设性反馈
- Accepting responsibility and apologizing to those affected by our mistakes, and learning from the experience / 承担责任并向受我们错误影响的人道歉，并从中学习
- Focusing on what is best not just for us as individuals, but for the overall community / 关注不仅对个人、而且对整个社区最有利的事
- Using welcoming and inclusive language / 使用欢迎和包容的语言

### Unacceptable Behaviors / 不可接受行为
...
社区领导者负责澄清和执行我们的可接受行为标准，并将对他们认为不当、威胁、冒犯或有害的任何行为采取适当且公正的纠正措施。

Community leaders have the right and responsibility to remove, edit, or reject comments, commits, code, wiki edits, issues, and other contributions that are not aligned to this Code of Conduct, and will communicate reasons for moderation decisions when appropriate.

社区领导者有权和责任删除、编辑或拒绝不符合本行为准则的评论、提交、代码、Wiki编辑、Issue和其他贡献，并将在适当时传达审核决定的理由。
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at **founder@zwiserfit.com**. All complaints will be reviewed and investigated promptly and fairly.

辱骂、骚扰或其他不可接受行为的实例可向负责执行的社区领导者报告，邮箱：**founder@zwiserfit.com**。所有投诉将得到及时公正的审查和调查。
...
社区领导者在确定任何其认为违反本行为准则的行为后果时，将遵循以下社区影响指南：

### 1. Correction / 纠正

**Community Impact / 社区影响：** Use of inappropriate language or other behavior deemed unprofessional or unwelcome in the community / 使用不当语言或其他被认为不专业或不受欢迎的行为。

**Consequence / 后果：** A private, written warning from community leaders, providing clarity around the nature of the violation and an explanation of why the behavior was inappropriate. A public apology may be requested. / 社区领导者的私下书面警告，明确说明违规性质并解释该行为为何不当。可能要求公开道歉。
...
有关本行为准则的常见问题解答，请参阅 [https://www.contributor-covenant.org/faq][FAQ] 上的 FAQ。翻译版本可在 [https://www.contributor-covenant.org/translations][translations] 获取。
...
> ⚙️ **Tristan** — Technical Architect / 技术架构官, ZWISERFIT
> *"Trust is built in the physical world, one punch-card at a time."*
> *"信任在物理世界中构建，每一次打卡都是一块基石。"*
